 ...
 * Lets mydnapedia.org/admin/ log in with GitHub without Netlify.
 *
 * DEPLOY (free):
 ...
 *     Then update the OAuth App's callback URL (step 1) to
 ...
 *         auth_endpoint: auth
 *
 * That's it — mydnapedia.org/admin/ "Login with GitHub" will now work.
 */
